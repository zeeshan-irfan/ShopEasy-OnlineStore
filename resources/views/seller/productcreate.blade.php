...
<div class="container shadow mt-3">
    <div class="row">
        <div class="col-12">
            <h4 class="text-center heading-line">Add new Product</h4>
        </div>
            ...
            <form id="createProductForm" action="{{route('product.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select id="category" name="category" class="form-select @error('category') is-invalid @enderror" aria-label="category">
                        <option value="" {{ old('category') == '' ? 'selected' : '' }}>Open this select menu</option>
                ...
                <div class="mb-3">
                    ...
                    <select id="brand" name="brand" class="form-select @error('brand') is-invalid @enderror" aria-label="brand">
                        <option value="" {{ old('brand') == '' ? 'selected' : '' }}>Open this select menu</option>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('productid') is-invalid @enderror" id="productid" name="productid" value="{{old('productid')}}" placeholder="If Any">
                ...
                <div class="row mb-3">
                    <div class="">
                        ...
                        <input type="hidden" class="form-control @error('size') is-invalid @enderror" id="size" name="size" value="{{old('size')}}" placeholder="No Size Specified" readonly>
                ...
                <div class="row mb-3">
                    <div class="">
                        ...
                        <input type="hidden" class="form-control @error('color') is-invalid @enderror" id="color" name="color" value="{{old('color')}}" placeholder="No Colors Specified" readonly>
                ...
                <div class="mb-3">
                    <label for="images" class="form-label fw-bold">Upload images (Min 3 required)</label>
